...
//const a = document.querySelector('#recolor-background-first-card');



//Покраска первой карточки

const recolorBackgroundFirstCardButton = document.getElementById('recolor-background-first-card-button')
...
const recolorBackgroundAllCardsButton = document.getElementById('recolor-background-all-cards-button')
